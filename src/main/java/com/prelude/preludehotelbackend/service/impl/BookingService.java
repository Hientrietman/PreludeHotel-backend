...
import com.prelude.preludehotelbackend.service.interfaces.IBookingService;
...
public class BookingService implements IBookingService {
    ...
    public Response saveBooking(Long roomId, Long userId, Booking bookingRequest) {
        ...
        try {
            ...
            List<Booking> existingBookings = room.getBookingsList();

            if (!roomIsAvailable(bookingRequest, existingBookings)) {
                throw new GenericException("Room not Available for selected date range");
            }
    ...
    public Response findBookingByConfirmationCode(String confirmationCode) {
        ...
        try {
            Booking booking = bookingRepository.findByBookingConfirmationCode(confirmationCode).orElseThrow(() -> new GenericException("Booking Not Found"));
            BookingResponse bookingDTO = Utils.mapBookingEntityToBookingDTOPlusBookedRooms(booking, true);
            response.setStatusCode(200);
            response.setMessage("successful");
    ...
    public Response getAllBookings() {
        ...
        try {
            ...
            List<BookingResponse> bookingDTOList = Utils.mapBookingListEntityToBookingListDTO(bookingList);
            response.setStatusCode(200);
            response.setMessage("successful");
    ...
    public Response cancelBooking(Long bookingId) {
        ...
        try {
            bookingRepository.findById(bookingId).orElseThrow(() -> new GenericException("Booking Does Not Exist"));
